...
export default function Home() {
  ...
  return (
    <>
      <div className="h-[100vh] w-full flex flex-col justify-center items-center text-gray-400 md:hidden">
        <h1>Please try in a Desktop</h1>
        <p className="mt-4 text-sm text-gray-500 px-7 text-center">
          Some of the features might not be supported in your device{" "}
        </p>
      </div>
      <div className="bg-black text-white hidden md:flex items-center flex-col px-4 lg:px-28 py-4 ">
        {/* NAVBAR SECTION */}
          ...
          <div className="absolute flex justify-center flex-col items-center z-40">
            <div className="flex justify-center flex-col items-center">
              ...
              <div className="flex flex-col text-lg text-gray-500 items-center">
                <p>
                  Practice real-world interview scenarios and receive
        ...
        <div className="md:h-[85vh] w-full flex flex-col items-center bg-gradient-to-t from-gray-900 rounded-3xl p-4 md:px-24 mt-16">
          ...
          <div className="flex flex-col md:flex-row mt-4 items-center gap-12">
            ...
            <div className="flex flex-col justify-center items-center gap-4 md:mt-32">
              ...
              <p className="text-gray-500 text-center">
                Receive detailed, actionable and personalized feedback
                immediately after your practice session with correct answer.
              </p>
            </div>
            <div className="flex flex-col justify-center items-center gap-4">
              <div className="border-4 rounded-full text-gray-300 border-blue-900 p-5 ">
              ...
              <p className="text-gray-500 text-center">
                Monitor your improvements with our intuitive performance
                analytics dashboard. Currently it is under development.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="FeatBox2 flex flex-col md:flex-row w-full mt-60 mb-40">
            ...
            <div className="w-full md:w-[30%] ">
              ...
              >
                ...
                <p className="text-gray-400">
                  Get your interview recorded video for analysis after
                  completing your interview interview with feedback of AI
                </p>
              </div>
            </div>
          </div>
