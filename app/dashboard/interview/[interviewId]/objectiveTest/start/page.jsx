...
const page = ({ params }) => {
  ...
  return (
    <div className="bg-gray-200 text-black my-8 py-16 px-12 rounded-xl shadow-xl">
      {loading ? (
        <Loader />
      ) : (
        <div>
          {interviewData && (
            <div className="">
              ...
              <div className="flex flex-col mt-10">
                <div
                  onClick={() => setOption(1)}
                  className={`w-[90%] h-[13vh] rounded-lg flex items-center gap-7 px-4 ${
                    option && option == 1 ? "shadow-lg" : ""
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <div className="flex gap-8">
                      ...
                      <div className="mt-8">
                        You have attemped .. out of 10 questions.
                      </div>
                    </div>
