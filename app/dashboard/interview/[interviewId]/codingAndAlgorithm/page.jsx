...
const CodingAndTechnical = ({ params }) => {
    ...
    if (MockJsonResp) {
      ...
      if (resp) {
        ...
        router.push("/dashboard/interview/" + resp[0]?.mockId) +
          "/codingAndAlgorithm/algorithmRound";
      }
    } else {
      console.log("ERROR");
    }
    ...
    if (MockJsonResp) {
      ...
      if (resp) {
        ...
        router.push(
          "/dashboard/interview/" +
            resp[0]?.mockId +
            "/codingAndAlgorithm/codingRound"
        );
      }
    } else {
      console.log("ERROR");
  ...
  return (
    <div className="p-16">
      ...
      <div className="my-8">
        <h1 className="text-2xl font-semibold mb-6">Coding Challenges</h1>
        <div
          className="p-10 border rounded-lg bg-secondary hover:scale-105 hover:shadow-sm cursor-pointer transition-all w-[30vw]"
...
export default CodingAndTechnical;

// "Job position: Software developer, Years of Experience: 1, Coding language: Java " - Based on this information, generate 1 algorithm question with clear explanation for the interview and its answer which contains best possible algorithm and its detailed explanation with time complexity in JSON format. Give question and answer as main fields with scenario, problem and requirements as sub-fields in question and algorithm, explanation and time complexity as sub-fields in answer in JSON format.
